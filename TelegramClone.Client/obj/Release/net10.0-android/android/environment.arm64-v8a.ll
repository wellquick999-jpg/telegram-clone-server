...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [25 x i8] c"com.yourname.mymessenger\00", align 1
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [35 x i8] c"libaot-TelegramClone.Shared.dll.so\00", align 1
@.DSOCacheEntry.9_name = private unnamed_addr constant [35 x i8] c"libaot-TelegramClone.Client.dll.so\00", align 1
